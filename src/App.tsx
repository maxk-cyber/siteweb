...
} from './components/ExperienceShell';
import { HeroProofDeck } from './components/HeroProofDeck';
...
function App() {
  ...
  return (
    <ExperienceShell experience={experience}>
      <main data-motion={preferences.motion} data-vibe={preferences.vibe}>
          ...
          <div id="top" className="hero-grid">
            <div className="hero-copy">
              ...
              <div className="hero-actions">
                <MagneticAnchor className="button button-primary" href="#action-plan">
                  Build an action plan
                </MagneticAnchor>
                <MagneticAnchor className="button button-ghost" href="#scanner">
                  Run the trust scan
                </MagneticAnchor>
              </div>

              <HeroProofDeck motion={preferences.motion} />
        ...
        <section id="contact" className="cta-section" aria-labelledby="contact-title">
          ...
          <MagneticAnchor
            ...
            href="mailto:hello@maxk-cyber.com?subject=Launch%20readiness%20scan"
          >
